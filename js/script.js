...
let arrayMafia = [],
    ...
    play.addEventListener('click', function(e){
        ...
        for(let i = 0; i < inputMafia.value; i++ ){arrayMafia[i] = 'mafia';}
        for(let i = 0; i < inputDoctor.value; i++ ){arrayDoctor[i] = 'doctor';}
        for(let i = 0; i < inputSheriff.value; i++ ){arraySheriff[i] = 'sheriff';}
        for(let i =0; i < inputPlayer.value; i++){ arrayPlayer[i] = 'player';}  
